...
#ifndef __invdyn_task_vel_joint_hpp__
#define __invdyn_task_vel_joint_hpp__
...
class TaskJointVel : public TaskMotion
{
public:
  ...
  TaskJointVel(const std::string & name, RobotWrapper & robot, const double & dt);

  virtual ~TaskJointVel() {}
